...
API_CONFIG_TEXAU_PROXY_HOST = os.getenv(
    "API_CONFIG_TEXAU_PROXY_HOST", "http://103.199.185.171:45785"
)
API_CONFIG_TEXAU_PROXY_PORT = os.getenv("API_CONFIG_TEXAU_PROXY_PORT", "47192")
API_CONFIG_TEXAU_PROXY_USER = os.getenv(
    "API_CONFIG_TEXAU_PROXY_USER", "Selmalharlakdawala"
)
API_CONFIG_TEXAU_PROXY_PASS = os.getenv("API_CONFIG_TEXAU_PROXY_PASS", "V7x5DcU")
...
API_CONFIG_TEXAU_PROXY_NAME = os.getenv(
    "API_CONFIG_TEXAU_PROXY", "ProxySellerIndia"
)
...
API_CONFIG_SENDINBLUE_CREDIT_UPDATE_TEMPLATE_ID = os.getenv(
    "API_CONFIG_SENDINBLUE_CREDIT_UPDATE_TEMPLATE_ID", 5
)
