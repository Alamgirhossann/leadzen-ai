...
from app.realtime.common import RealTimeUploadResponse
from app.config import API_CONFIG_DEFAULT_STATUS_CHECK_INTERVAL
from test.common import (
    TEST_CONFIG_API_BASE_URL,
    TEST_CONFIG_REALTIME_HEADERS,
    TEST_CONFIG_REALTIME_USER_ID,
)
...
def test_realtime_excel_upload_pass():
    ...
    response = requests.post(
        ...
        files=files,
        data={
            "user_id": TEST_CONFIG_REALTIME_USER_ID,
            "requirement": "this is from test",
        },
