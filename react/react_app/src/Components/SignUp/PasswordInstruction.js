                  ...
                  <div class="col-md-6 robot-container order-md-12">
                    <div class="password-instruction">
                      <p class="fw-bold">
                        ...
                        We don’t want to make it too easy for others to guess.
                        So you password must have
                        <span className="text-danger">1 uppercase</span>,{" "}
                        <span className="text-danger">1 lowercase</span>,{" "}
                        <span className="text-danger">1 special</span> and{" "}
