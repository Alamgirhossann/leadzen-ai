                                    ...
                                    <div class="col-md-6 robot-container order-md-12">
                                        <div class="sign-up-email-error">
                                            <p class="fw-bold text-center">
                                                ...
                                                <br />Please add a valid email ID
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 order-md-1">
                                        <div class="sign-up-form">
                                            ...
                                            <form class="sign-up-form" class="#">
                                                <div class="mb-3">
                                                    <input type="text" class="w-100 from-control" placeholder="Enter your name" id="username" />
                                                </div>
                                                <div class="mb-3">
...
export default SignUpEmailError;