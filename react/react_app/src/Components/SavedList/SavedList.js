...
const SavedList = () => {
    ...
    let myLeads = [{name:'John Smith',desc:'English Speaker',comp:'Hexagon AB',search_date:'12/05/2021'},
                     {name:'Joe Mama',desc:'English Speaker',comp:'Apple INC',search_date:'12/05/2021'}];
    let productLeads = [{name:'Ty Neadik',desc:'English Speaker',comp:'Hexagon AB',search_date:'12/05/2021'},
    {name:'Mike Hunt',desc:'English Speaker',comp:'Apple INC',search_date:'12/05/2021'}];
                        ...
                        <ul className="navbar-nav-profile navbar-nav align-items-center ms-auto">
                            <li className="nav-item me-md-4 me-3">
                                <a className="nav-icon-menu nav-link" href="#"><img src="assets/images/menu-home.png"
                                    alt="home here" />Home</a>
                            </li>
                            <li className="nav-item me-md-4 me-3">
                            <a className="nav-icon-menu nav-link" href="/savedList"><span className="text-danger"><img src="assets/images/menu-saved-list.png"
                                    alt="saved here" />Saved Lists</span></a>
                            </li>
                            <li className="nav-item me-md-4 me-3">
            ...
            <div className="text-center p-4 my-3">
                <div className="user-lead-top mb-2 head-btn-style">
                    <div className="d-flex align-items-center">
                        <h5 className="m-0"><img src="assets/images/back-union.png" alt="" /> Saved Leads</h5>
                    </div>
                ...
                <div className="lead-accordion accordion" id="accordionExample2">
                    <div className="accordion-item">
                        <h2 className="accordion-header">
                            <button className="accordion-button alignment" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne" style={{ background: "white", borderRadius: "15px", padding: "10px" }}>
                                ...
                                <div className="second-grid">
                                    <input type='text' className="description" placeholder='Add Description...' />
                                </div>
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample2">
                            <div className="accordion-body">
                            {myLeads.map(data => (
                                    <div className='container-style mb-2'>
                                        <div key={data.name} className="save-list-container">
                                            <p className='save-profile text-danger'><img src="assets/images/author-image.png" alt="" /></p>
                                            ...
                                            <p className='save-view-btn'><a href="/detailedInfo" className='button'>View Profile</a></p>
                                            <p className='save-close-btn'><img src="assets/images/close-user.png" alt="" /></p>
                                        </div>
                                    </div>
                                    ))}
                            </div>
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed alignment" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseTwo" style={{ background: "white", borderRadius: "15px", padding: "10px" }}>
                                <div className=" first-grid head-align">
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed alignment" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseThree" style={{ background: "white", borderRadius: "15px", padding: "10px" }}>
                                <div className=" first-grid head-align">
                                    <span className="me-3 fw-bold">Product Designer Leads</span>
                                    <span>
                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                            <div className="accordion-body">
                                <div className='container-style mb-2'>
                                    <div className="save-list-container">
                                        <p className='save-profile text-danger'><img src="assets/images/author-image.png" alt="" /></p>
                                        <p className='save-name'>John Smith</p>
                                        <div className='save-speaker'>
                                            <div>
                                                <small className='d-block'>English Speaker</small>
                                        ...
                                        <p className='save-view-btn'><a href="" className='button'>View Profile</a></p>
                                        <p className='save-close-btn'><img src="assets/images/close-user.png" alt="" /></p>
                                    </div>
                                </div>
