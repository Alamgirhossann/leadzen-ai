...
const SavedList = () => {
    ...
    var myLeads = [{name:'John Smith',desc:'English Speaker',comp:'Hexagon AB',search_date:'12/05/2021'},
                     {name:'Joe Mama',desc:'English Speaker',comp:'Apple INC',search_date:'05/05/2021'}];
    var productLeads = [{name:'Ty Neadik',desc:'German Speaker',comp:'Microsoft AB',search_date:'14/05/2021'},
                        {name:'Mike Hunt',desc:'Japanese Speaker',comp:'Amazon INC',search_date:'17/05/2021'}];
                            ...
                            {myLeads.map(data => (
                                    <div className='container-style mb-2'>
                                        <div key={data.name} className="save-list-container">
                                            ...
                                            <a href="savedList" onClick={name => handleDelete(data.name)}><p className='save-close-btn'><img src="assets/images/close-user.png" alt="" /></p></a>
                                        </div>
                                    </div>
                                    ))}
                            </div>
