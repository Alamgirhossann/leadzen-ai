...
//   const [boolupdatedescription, setBoolUpdateDescription] = useState({
//     index: -1,
//   });
...
//           <div
//             key={alldata.id}
//             className="lead-accordion accordion"
...
//                     {boolupdateName.index == index ? (
//                       <input
//                         id="saved-list-name-input"
//                         type="text"
//                         className="form-control"
...
//                           className="m-0"
//                           onClick={() =>
//                             handleUpdate(alldata.list_name, index, "name")
//                           }
//                         >
//                           <img
//                             className="m-0"
...
//                     {boolupdatedescription.index == index ? (
//                       <input
//                         id="saved-list-description-input"
//                         type="text"
...
//                               <a
//                                 onClick={(e) =>
//                                   handleIndexDelete(alldata.id, index)
//                                 }
//                               >
