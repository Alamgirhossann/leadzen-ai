        ...
        <>
            {popup ? (<div style={{width: "450px"}}><Modal.Dialog>
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-6 col-xs-3">
                                {searchicon ? <div className="float-right" onClick={() => setSearchIcon(false)}>
                ...
                <Modal.Body className="modal-dialog-scrollable" style={{height: "150px", overflow: "auto"}}>
                    {formname ? <div>
                        ...
                        if (search == "") {
                            ...
                            }}><span style={{marginLeft: "10px"}}>{data.list_name}
                ...
                <Modal.Footer className="justify-content-center">
                    {!formname ? <Button className="btn btn-primary " style={{
                            backgroundColor: "white",
                            color: "black",
                            borderRadius: "0",
                            borderColor: "whitesmoke"
                        }} onClick={() => setFormName(true)}>Add new list
                            <span style={{marginLeft: "5px"}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                   fill="currentColor"
