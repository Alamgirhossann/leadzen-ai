            ...
            popup ? ( <
                ...
                div className = "col-6 col-xs-3" > {
                    searchicon ? ( <
                        ...
                        input id = "popup-form-search-input"
                ...
                style = {
                    ...
                    formname ? ( <
                        ...
                        label >
                        List Name <
                        input id = "popup-form-list-name-input"
                        type = "text"
                        value = { name }
                        onChange = {
                ...
                <
                Modal.Footer className = "justify-content-center" > {!formname ? ( <
                ...
                img src = "assets/images/Frame 543.png"
                alt = "" / >
            )
        } <
        />
