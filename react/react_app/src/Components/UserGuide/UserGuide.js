                        ...
                        <div class="col-md-4 col-lg-3">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="one" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <select class="location-select" name="states[]">
                            ...
                            <div class="sidebar-search-for sidebar-widget p-4 my-3">
                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        <select class="form-control jobs-select">
                                            <option value="O1" data-badge="">All</option>
                                            <option value="O2" data-badge="">Followers</option>
                                            <option value="O3" data-badge="">Likers</option>
                                            <option value="O4" data-badge="">Commentors </option>
                                            <option value="O5" data-badge="">Job seekers</option>
                                            <option value="O6" data-badge="">Group Members</option>
                                        </select>
                                    </div>
                                    <button style={{background:"#FB3E3E"}} class="btn text-white" type="submit"><span className='pe-1'><FontAwesomeIcon  icon={faSearch} /></span> Search</button>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger w-auto mb-3"><img src="assets/images/user-guide-icon1.png" alt="title" /> https://www.linkedin.c...</div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger w-auto mb-3"><img src="assets/images/user-guide-icon2.png" alt="title" /> John Smith</div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger mb-3"><img src="assets/images/user-guide-icon3.png" alt="title" /> Designer</div>
                                                    <div class="btn btn-danger mb-3"><img src="assets/images/user-guide-icon4.png" alt="title" /> New York</div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger w-auto mb-3">Give me list of employee in Amazon</div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger w-auto mb-3">I want contact numbers of my list of customers</div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="user-guide-box p-3 my-3">
                                                    <div class="btn btn-danger w-auto mb-3">Give me contact numbers of people who are following Dunzo on Instagram</div>
