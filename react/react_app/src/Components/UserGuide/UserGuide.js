                    ...
                    <div className="row">
                        <div className="col-md-4 col-lg-3">
                            <div className="sidebar-search-for sidebar-widget p-4 my-3">
                                ...
                                <p>Bulk Search by uploding <a href="#" onChange={handleCSVFile} className="text-danger" data-bs-toggle="modal" data-bs-target="#bulkmodal">csv</a></p>
                            </div>
                            <div className="sidebar-search-for sidebar-widget p-4 my-3">
                        ...
                        <div className="col-md-8 col-lg-9">
                                        ...
                                        <form action="#" className="search-form4 d-flex mb-3">
                                            <div className="input-group">
                                                <div className="input-placeholder">
                                                    <input className="ps-3" onBlur={handleHeadSearch} type="text" required />
                                                    <div className="placeholder">
                                                        Eg: I want to <span>email IDs</span> of people following <span>Flipkart Facebook Page</span>
                                                    </div>
                                                </div>
                                                <button className="btn text-white" onClick={handleHeadSubmit} type="submit"><span className='pe-1'><FontAwesomeIcon icon={faSearch} /></span> Search</button>
                                            </div>
                                        </form>
                            ...
                            <div className="user-widget-box text-center p-4 my-3">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div className="user-guide-box p-3 my-3">
                                                    ...
                                                    <a href="/searchResult" className="btn try-it-btn">Try it!</a>
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="user-guide-box p-3 my-3">
                                ...
                                <a href="/howToUse" className="text-danger"><u>Take a Demo</u></a>
                            ...
                            <div className="user-widget-box p-4 my-3 text-center">
                                ...
                                <form action="#" className="search-form-lg m-auto">
                                    <div className="input-group">
                                        <input type="text" className="form-control" onBlur={handleURL} placeholder="Paste Social Media URL" />
                                        <button className="btn btn-danger" onClick={handleTypeSubmit} type="submit"><img src="assets/images/social-search-past.png" alt="title" /></button>
                                    </div>
                                </form>

                                <div className="radio-form-check d-block my-3">
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="checkbox" onChange={handleType} name="inlineRadioOptions" id="inlineRadio1" />
