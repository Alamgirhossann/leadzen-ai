                        ...
                        !props.details.phones ? ( <
                            ...
                            div className = "" > {
                                ...
                                listPhones.length > 0 ?
                                    listPhones.map((item, index) => ( <
                                        ...
                                        <
                                        img src = "assets/images/Group 1338.png"
                                        alt = "" / >
                                        <
                                        small className = "ms-2"
                                        key = { index } > { item.phone } < /small> <
                                        /div> <
                                        div className = "d-flex align-items-center" >
                                        <
                                        a className = "me-2 ms-2"
                                        href = "#"
                                        onClick = {
                                            (e) => {
                                                e.preventDefault();
                            ...
                            div > {
                                ...
                                div > {
                                        ...
                                        div className = "ms-2 d-flex align-items-center mb-3" >
                                        <
                                        small > { props.details.gender ? props.details.gender.content : null } <
                                        /small> <
                                        /div> {
                                            ...
                                            h6 > Location < /h6> <
                                                ...
                                                h4 > Associated Jobs and Companies < /h4> {
                                                    props.proxyData && props.proxyData.experiences ?
                                                        props.proxyData.experiences.map((comp) => ( <
                                                            ...
                                                            td >
                                                            <
                                                            div className = "d-flex justify-content-between" > { /*<p>{comp.url}</p>*/ } { /*<a href={comp.url}>*/ } { /*  <img*/ } { /*    className="ms-2"*/ } { /*    style={{ height: "10px" }}*/ } { /*    src="assets/images/Union (1).png"*/ } { /*    alt=""*/ } { /*  />*/ } { /*</a>*/ } <
                                                            /div> <
                                                            /td> <
                                                            /div>
                                                        )) :
                                                ...
                                                <
                                                h4 > Associated Locations < /h4> { /*<div>*/ } { /*  <Map*/ } { /*    google={props.google}*/ } { /*    zoom={15}*/ } { /*    style={{ width: "80%", height: "80%" }}*/ } { /*    initialCenter={{ lat: 9.761927, lng: 79.95244 }}*/ } { /*  />*/ } { /*</div>*/ } <
                                                /div> <
                                                div className = "col-md-6" >
                                                <
                                                ...
                                                div className = "user-promote-slider" > {
                                                    ...
                                                    props.proxyData.people_also_viewed.map((profile) => ( <
                                                        ...
                                                        p className = "d-block mt-3" > { profile.summary }
                                                        at { profile.location } <
                                                        /p> <
                                                        /div>
                                                    )) :
