                ...
                <div class="main-wrapper container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-9">
                            ...
                            <div>
                                <p className='mt-3'>Extracted Results for: <span className='link-style'><img src="assets/images/Vector (2).png" alt="" /> https://www.instagram.com/</span><span className='link-style'>Followers</span> <a className='text-danger' href="#">Clear All</a></p>
                            </div>
                            <div class="user-widget-box  my-3">
                                <div className="d-flex align-items-center justify-content-between py-3">
                                    <div className='d-flex align-items-center '>
                                        ...
                                        <small className=''><b>7</b> of <b>218</b> Searched profiles</small>
                                    </div>
