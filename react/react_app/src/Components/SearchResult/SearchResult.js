                ...
                <div className="modal-dialog">
                    <div className='modal-message'>
                        <p>
                            ...
                            Ensure that the first column has the unique values you’re searching for.
                                    ...
                                    <div className="search-promote-content">
                                        <form className="form-inline d-flex my-2 my-lg-0">
                                            <input className="form-control mr-sm-2" type="search"
                                                onBlur={handleSearch} placeholder="Search"
                                                aria-label="Search" />
                                ...
                                <div className="d-flex align-items-center justify-content-between py-3">
                                    ...
                                    <div className='d-flex'>
                                        <small className='unlock-btn'>
                                            Unlock Profile
                                            <img className='ps-3' src="assets/images/Group 1617.png"
                                                alt="" />
                                        </small>
                                        <small className='unlock-btn'>
                                            Unlock Mails
                                        ...
                                        <small className='export-btn'>
                                            Export
                                            <img className='ps-3' src="assets/images/export.png"
                                                alt="" />
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div className="user-promote-slider">
                                    <div className="item">
                                        <div className="user-promote-item">
                                            <p className="">
                                                Want to extract contacts of group members in a
                                                LinkedIn group?
                                            </p>
                                    ...
                                    <div className="item">
                                        <div className="user-promote-item">
                                            <p className="">
                                                Need a list of companies in semi-conductor space
